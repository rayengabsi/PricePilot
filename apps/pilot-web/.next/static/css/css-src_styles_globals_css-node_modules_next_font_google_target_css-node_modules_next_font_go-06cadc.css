...
.btn-primary {
  ...
  --tw-shadow: 0 4px 14px 0 rgba(124, 58, 237, 0.25);
...
.card {
  ...
  background-color: rgb(255 255 255 / var(--tw-bg-opacity, 1));
  padding: 1.5rem;
  --tw-shadow: 0 1px 3px 0 rgb(0 0 0 / 0.06), 0 1px 2px -1px rgb(0 0 0 / 0.06);
...
.via-pilot-500\/5 {
  --tw-gradient-to: rgb(139 92 246 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), rgb(139 92 246 / 0.05) var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.via-pilot-700 {
  --tw-gradient-to: rgb(109 40 217 / 0)  var(--tw-gradient-to-position);
...
.shadow-elevated {
  --tw-shadow: 0 20px 25px -5px rgb(0 0 0 / 0.08), 0 8px 10px -6px rgb(0 0 0 / 0.06);
  --tw-shadow-colored: 0 20px 25px -5px var(--tw-shadow-color), 0 8px 10px -6px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
.shadow-glow {
  --tw-shadow: 0 0 40px -10px rgba(124, 58, 237, 0.4);
...
.shadow-pilot-lg {
  --tw-shadow: 0 10px 40px -10px rgba(124, 58, 237, 0.35);
...
.hover\:border-pilot-200:hover {
  --tw-border-opacity: 1;
  border-color: rgb(221 214 254 / var(--tw-border-opacity, 1));
}
.hover\:border-pilot-300:hover {
  --tw-border-opacity: 1;
  border-color: rgb(196 181 253 / var(--tw-border-opacity, 1));
}
.hover\:border-pilot-400:hover {
  --tw-border-opacity: 1;
...
.hover\:bg-pilot-100:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(237 233 254 / var(--tw-bg-opacity, 1));
}
.hover\:bg-pilot-700:hover {
  --tw-bg-opacity: 1;
...
.hover\:shadow-card-hover:hover {
  --tw-shadow: 0 10px 15px -3px rgb(0 0 0 / 0.08), 0 4px 6px -4px rgb(0 0 0 / 0.06);
  --tw-shadow-colored: 0 10px 15px -3px var(--tw-shadow-color), 0 4px 6px -4px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
.hover\:shadow-pilot:hover {
  --tw-shadow: 0 4px 14px 0 rgba(124, 58, 237, 0.25);
  --tw-shadow-colored: 0 4px 14px 0 var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
.hover\:shadow-pilot-lg:hover {
  --tw-shadow: 0 10px 40px -10px rgba(124, 58, 237, 0.35);
  --tw-shadow-colored: 0 10px 40px -10px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
...
.group:hover .group-hover\:bg-pilot-200 {
  --tw-bg-opacity: 1;
...
@media (prefers-color-scheme: dark) {
  ...
  .dark\:bg-pilot-900\/30 {
    background-color: rgb(76 29 149 / 0.3);
  }

  .dark\:bg-pilot-900\/50 {
  ...
  .dark\:bg-success-400\/20 {
    background-color: rgb(52 211 153 / 0.2);
  }

  .dark\:bg-warning-400\/20 {
  ...
  .dark\:hover\:border-pilot-500:hover {
    --tw-border-opacity: 1;
    border-color: rgb(139 92 246 / var(--tw-border-opacity, 1));
  }

  .dark\:hover\:border-pilot-600:hover {
    --tw-border-opacity: 1;
    border-color: rgb(124 58 237 / var(--tw-border-opacity, 1));
  }

  .dark\:hover\:border-pilot-800:hover {
    --tw-border-opacity: 1;
    border-color: rgb(91 33 182 / var(--tw-border-opacity, 1));
  }
  ...
  .dark\:hover\:bg-pilot-900\/50:hover {
    background-color: rgb(76 29 149 / 0.5);
  }
  ...
  .dark\:hover\:text-pilot-300:hover {
    --tw-text-opacity: 1;
    color: rgb(196 181 253 / var(--tw-text-opacity, 1));
  }
  ...
  .dark\:hover\:text-pilot-400:hover {
    --tw-text-opacity: 1;
    color: rgb(167 139 250 / var(--tw-text-opacity, 1));
  }
  ...
  .group:hover .dark\:group-hover\:bg-pilot-900\/70 {
